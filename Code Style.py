...
# This function to calculate the area of a rectangle is not very readable. Can you refactor it,
# and then call the function to calculate the area with base of 5 and height of 6?
